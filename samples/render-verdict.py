...
<footer>
  ...
  <p style="margin-top: 1rem; font-size: 0.85rem; color: #888;">
    Returned verdict artifacts are Ed25519-signed. Use the authenticated
    <code>/v1/health/key</code> response for this tenant's actual key ID and verification
    key. A Red finding is a detection result, not proof that an action was blocked;
    no Red is not proof of complete telemetry coverage.
  </p>
</footer>
</body>
</html>
